...
namespace YG
{
    public class ViewingAds : MonoBehaviour
    {
        ...
        [Tooltip("Данный скрипт будет ставить звук или верменную шкалу (взависимости от выбранной настройки PauseType) на паузу при открытии рекламы. После закрытия рекламы звук и временная шкала придут в изначальное значение - до открытия рекламы")]
        ...
        {
            Pause(false);
            Debug.Log("CloseRewAdErrorCloseRewAdErrorCloseRewAdErrorCloseRewAdErrorCloseRewAdError");
        }
